...
public class Thirdleveltwo extends JFrame implements ActionListener {
    
    JTextField answer;
    
    int random , low  = 0 , high = 100 , toohigh , toolow , slhigh , sllow , attempt = 10;
    ...
    Thirdleveltwo(){
        ...
        JPanel contentPane = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                int w = getWidth();
                int h = getHeight();
                GradientPaint gradient = new GradientPaint(0, 0, new Color(0xB1BCCB), w, 0, new Color(0x3F78A2));
        ...
        JLabel text = new JLabel("Guess Number between 0 to 100");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == submit){
            if(submit.getText() == "Next")
            {
               ...
               if( attempt == 0){
                   setVisible(false);
                   new Gameover("300").setVisible(true);
               }
               else{
                   try {
