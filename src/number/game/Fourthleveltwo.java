...
public class Fourthleveltwo extends JFrame implements ActionListener {
    
    JTextField answer;
    
    int random , low  = 0 , high = 300  , toohigh , toolow , slhigh , sllow , attempt = 6;
    ...
    Fourthleveltwo(){
        ...
        JLabel scoretext = new JLabel("Score : 600");
        ...
        JLabel text = new JLabel("Guess Number between 0 to 300");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == submit){
            if(submit.getText() == "Next")
            {
               ...
               if( attempt == 0){
                   setVisible(false);
                   new Gameover("600").setVisible(true);                   
               }
               else{
                   try {
