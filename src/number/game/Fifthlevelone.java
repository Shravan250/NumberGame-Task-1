...
public class Fifthlevelone extends JFrame{
    ...
    Fifthlevelone(){
        ...
        JLabel reward = new JLabel("Reward : 500 ");
        reward.setBounds(170 , 130 , 250 , 30 );
        reward.setFont(new Font("Raleway" , Font.BOLD , 20));
        add(reward);
        
        JLabel diff = new JLabel("Difficulty : Extreme");
        ...
        new java.util.Timer().schedule(new java.util.TimerTask(){
           ...
           public void run(){ 
              setVisible(false);
              new Fifthleveltwo().setVisible(true);
           }
        },3000);
