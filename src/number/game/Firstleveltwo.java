...
public class Firstleveltwo extends JFrame implements ActionListener {
    
    JTextField answer;
    
    int random , low  = 0 , high = 10 ,  toohigh , toolow , slhigh , sllow;
    ...
    Firstleveltwo(){
        ...
        JPanel contentPane = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                int w = getWidth();
                int h = getHeight();
                GradientPaint gradient = new GradientPaint(0, 0, new Color(0xF7FAFF), w, 0, new Color(0x5DBCD2));
        ...
        JLabel levelone = new JLabel("Level - 1");
        ...
        JLabel text = new JLabel("Guess Number between 0 to 10");
